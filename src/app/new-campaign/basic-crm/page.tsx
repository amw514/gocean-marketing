...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    description: "5-day email nurture sequence",
    prompts: [
      {
        id: 1,
...
Email 5 adds urgency and scarcity with a strong CTA. It follows the format of the hook being the subject line, the story being the body, the offer being the call to action followed by the website.`
  ...
  },
  {
    ...
    description: "Prepare clients for booked calls",
    prompts: [
      {
        id: 1,
        title: "Pre-Call Sequence",
        content: "Write a pre-call nurture sequence for clients who booked a call to educate and prepare them, as well as an engaging text reminder campaign."
      }
    ]
  },
  {
    ...
    description: "Re-engage prospects who didn't book",
    prompts: [
      {
        id: 1,
  ...
  },
  {
    ...
    description: "Keep prospects warm over time",
    prompts: [
      {
        id: 1,
...
export default function BasicCRM() {
  ...
  const createNewProject = () => {
    ...
    const newProject: Project = {
      ...
      messages: [
        {
          role: "assistant",
          content: "Welcome! Let's start with your Basic CRM Setup. Please provide your Brand Report to ensure campaign alignment.",
          step: 1
        }
      ],
      currentStep: 1,
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch("/api/new-campaign/basic-crm", {
        method: "POST",
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isCompleted && "bg-purple-800 hover:bg-purple-900",
                !isCompleted && isAvailable && "bg-purple-600 hover:bg-purple-700",
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className={cn(
        ...
        <div className="p-4">
          {isSidebarOpen && (
            <h1 className="text-2xl font-bold text-white mb-6">Basic CRM Setup</h1>
          )}
          <Button
              ...
              <div ref={chatContainerRef} className="flex-1 overflow-y-auto space-y-4 mb-4">
                {getCurrentProject()?.messages.map((message, index) => (
                  <div
                    ...
                    className={cn(
                      "p-3 rounded-lg",
                      message.role === "user" ? "bg-purple-600 ml-auto" : "bg-gray-700",
                      "max-w-[80%]"
                    )}
                  >
